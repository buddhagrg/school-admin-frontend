...
import { Box, Collapse, Divider, List, ListItemButton, ListItemIcon, ListItemText, Toolbar, Typography } from "@mui/material";
    ...
    return (
        <div>
            <Toolbar>
                ...
                <Typography variant="h6" sx={{ ml: 2, color: blue[800] }}>School Admin</Typography>
            </Toolbar>
            <Divider />
            <List
                component="nav"
