...
import { Box, FormControl, FormControlLabel, FormHelperText, FormLabel, Grid, InputLabel, MenuItem, Radio, RadioGroup, Select, SelectChangeEvent, TextField } from "@mui/material";
    ...
    return (
        ...
        <form onSubmit={onSubmit}>
            ...
            <TextField
                ...
                sx={{ marginTop: "30px" }}
            />
            <FormControl sx={{ marginTop: "30px", minWidth: { xs: "100%", md: "350px" } }} size="small" error={Boolean(errors.status)}>
                <InputLabel id="notice-status-label" shrink>Status</InputLabel>
                <Controller
                    name="status"
                    control={control}
                        ...
                        <Grid xs={12} lg={4} item>
                            {
                                ...
                                <FormControl sx={{ minWidth: { xs: "100%", md: "350px" } }} size="small" error={Boolean(errors.firstField)}>
                                    <InputLabel id="firstField" shrink>{getDependentRole("primaryDependents")}</InputLabel>
                                    <Controller
                                        name="firstField"
                                        control={control}
                                        render={({ field: { onChange, value }, fieldState: { error } }) => (
