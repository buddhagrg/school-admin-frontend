...
const MenuTableCell: React.FC<MenuTableCellProps> = ({
  ...
  return (
    <TableCell>
      ...
      >
        <MenuItem
          disabled={isEditPermissionAvailable(notice.authorId, notice.statusId, currentUserId)}
          component={Link}
...
export const NoticeDataTable: React.FC<NoticeDataTableProps> = ({ notice, actionCellType }) => {
  ...
  return (
    <>
      <TableRow hover>
        ...
        <TableCell>
          <Typography component={Link} to={`/app/notices/${notice.id}`} className='notice-title'>
            {notice.title}
          </Typography>
        </TableCell>
        <TableCell>{notice.author}</TableCell>
        <TableCell>
          <NoticeStatus statusId={notice.statusId} label={notice.status} />
        </TableCell>
