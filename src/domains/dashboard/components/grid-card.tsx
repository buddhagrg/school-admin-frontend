...
export const GridCard: React.FC<GridCardType> = (props) => {
    const {
        ...
        totalNumberPercInComparisonFromPrevYear
    } = props;
    ...
    return (
        <Card>
            <CardContent>
                <Typography component="div" color="text.secondary" gutterBottom>{heading}</Typography>
                <Box sx={{ display: "flex" }}>
                    <Typography variant="h6" gutterBottom sx={{ pr: 2 }}>{totalNumberCurrentYear}</Typography>
                    <Chip
