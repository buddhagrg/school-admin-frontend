...
import { Alert, Checkbox, FormControl, FormHelperText, InputAdornment, InputLabel, ListItemText, ListSubheader, MenuItem, Select, TextField, } from "@mui/material";
...
import { useAddUserToPolicyMutation, useGetEligibleLeavePolicyUsersQuery } from "../../../api/leave-api";
...
export const AddPeopleToPolicy: React.FC<AddPeopleToPolicyProps> = ({
    ...
    const { handleSubmit, control, formState: { errors }, setValue } = useForm<PolicyUsers>({
        defaultValues: { users: [] },
    ...
    return (
        ...
        >
            <Alert severity="info">
                ...
                and is being assigned to new one, then the person will only be part of the policy being assigned to.
            </Alert>
                ...
                <Controller
                    ...
                    render={({ field: { onChange, value: users } }) => (
                        ...
                        >
                            ...
                            {filteredUsers && filteredUsers.map(({ id, name }) => (
