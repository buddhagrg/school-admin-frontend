...
export const LeaveRequestFormSchema = BaseLeaveSchema.extend({
    from: z.union([z.string().transform(dtString => dtString ? parseISO(dtString) : null), z.null(), z.date()]),
    to: z.union([z.string().transform(dtString => dtString ? parseISO(dtString) : null), z.null(), z.date()]),
