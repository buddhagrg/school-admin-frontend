...
import { Box, FormControl, FormControlLabel, FormHelperText, FormLabel, InputLabel, MenuItem, Paper, Radio, RadioGroup, Select, TextField, Typography } from "@mui/material";
    ...
    return (
        <>
            <Box component={Paper} sx={{ p: 2 }}>
                <Typography variant="subtitle1" sx={{ mb: 3 }}>{operation} Class Teacher</Typography>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <FormControl>
                        <FormLabel id="demo-controlled-radio-buttons-group" sx={{ mt: 2 }}>Sections</FormLabel>
                        <Controller
                            name="section"
                            control={control}
                            render={({ field }) => (
                    ...
                    <FormControl fullWidth sx={{ mt: 2 }} size="small">
                        <InputLabel id="teacher-for-dropdown" shrink>Teacher</InputLabel>
                        <Controller
                            name="teacher"
                            control={control}
