            ...
            <CardContent>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <Typography variant="body1">{dob ? getFormattedDate(dob.toString(), DATE_FORMAT) : ""}</Typography>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2">Join Date</Typography>
                        <Typography variant="body1">{joinDate ? getFormattedDate(joinDate.toString(), DATE_FORMAT) : ""}</Typography>
                    </Grid>
                    <Grid item xs={12} sm={6}>
