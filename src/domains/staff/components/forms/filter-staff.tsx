...
import { Box, FormControl, FormHelperText, Grid, InputLabel, MenuItem, Paper, Select, TextField, Typography } from "@mui/material";
...
export const FilterStaff: React.FC<FilterStaffProps> = ({
    searchStaff,
    methods,
    isLoading
}) => {
    ...
    return (
        <Box component={Paper} sx={{ p: 2 }}>
            <Typography variant="body1" sx={{ mb: 3 }}>Filter Criteria</Typography>
            <Grid container spacing={2}>
                <Grid item md={4} xs={8}>
                    <FormControl fullWidth size="small" error={Boolean(errors.roleId)}>
                        <InputLabel id="staff-role" shrink>Staff Role</InputLabel>
                        <Controller
                            name="roleId"
                            control={control}
