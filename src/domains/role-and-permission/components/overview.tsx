  ...
  return (
    <>
      ...
      <Grid container spacing={3}>
        {data?.roles &&
          data?.roles.map(({ id, name, status, usersAssociated }) => (
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <div style={{ marginLeft: 'auto' }}>
                      ...
                      <Menu
                        ...
                        keepMounted
                      >
                        <MenuItem disabled={!state.roleStatus} onClick={handleEditRoleModal}>
                          Edit Role
                        </MenuItem>
                        <MenuItem
                          disabled={!state.roleStatus}
                          onClick={() => handleRoleStatus(false)}
                        >
                          Disable Role
                        </MenuItem>
                        <MenuItem
                          disabled={state.roleStatus}
                          onClick={() => handleRoleStatus(true)}
                        >
                          Enable Role
                        </MenuItem>
                      </Menu>
