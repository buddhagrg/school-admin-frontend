...
import { useReorderPeriodsMutation } from '../../levels-periods-api';

type ReorderPeriodProps = {
  closeModal: () => void;
  periods: Period[];
  academicLevelId: number;
};
export const ReorderPeriod: FC<ReorderPeriodProps> = ({ closeModal, periods, academicLevelId }) => {
