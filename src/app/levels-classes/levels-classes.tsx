...
import { useGetAcademicLevelsWithClassesQuery } from './levels-classes-api';
import { ResponsiveBox } from '@/components/responsive-box';
import { getErrorMsg } from '@/utils/helpers/get-error-message';
import { AddClassToLevel } from './components';
import { PageContentHeader } from '@/components/page-content-header';
import { ERROR_MESSAGE } from '@/components/errors';

export const LevelsClasses = () => {
  ...
  return (
    <>
      <PageContentHeader title='Academic Level and Class Relation' icon={Info} />
